                    ...
                    <form action="{{ route('basket.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div id="segment" class="col-sm-4 col-md-4 col-xs-12 mb-3"> 
                                        <label class="mt-3 mb-3"><b> Exchange Type </b></label>
                                        <select  class="form-control has-error" name="segment" id="exchange_type" required>
...
@section('scripts')
    ...
    <script>
        ...
        function dynamic_field(number, click_id, token_name, strike_type) {
            ...
            html +='<td><label class="mt-1"><b>Strike Qty</b></label><div class="mt-1"><input  style="height:30px; width:80px" type="text" class="selectpicker" name="data['+number+'][strick_qty]"></input required></div></td>';
